...
function findWasmBinary() {
  return locateFile('night_city.wasm');
}
...
var ASM_CONSTS = {
  104772: () => { if (document.fullscreenElement) return 1; },  
 104818: () => { return document.getElementById('canvas').width; },  
 104870: () => { return parseInt(document.getElementById('canvas').style.width); },  
 104938: () => { document.exitFullscreen(); },  
 104965: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 105038: () => { if (document.fullscreenElement) return 1; },  
 105084: () => { return document.getElementById('canvas').width; },  
 105136: () => { return screen.width; },  
 105161: () => { document.exitFullscreen(); },  
 105188: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 105321: () => { return window.innerWidth; },  
 105347: () => { return window.innerHeight; },  
 105374: () => { if (document.fullscreenElement) return 1; },  
 105420: () => { return document.getElementById('canvas').width; },  
 105472: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105540: () => { if (document.fullscreenElement) return 1; },  
 105586: () => { return document.getElementById('canvas').width; },  
 105638: () => { return screen.width; },  
 105663: () => { return window.innerWidth; },  
 105689: () => { return window.innerHeight; },  
 105716: () => { if (document.fullscreenElement) return 1; },  
 105762: () => { return document.getElementById('canvas').width; },  
 105814: () => { return screen.width; },  
 105839: () => { document.exitFullscreen(); },  
 105866: () => { if (document.fullscreenElement) return 1; },  
 105912: () => { return document.getElementById('canvas').width; },  
 105964: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106032: () => { document.exitFullscreen(); },  
 106059: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 106117: () => { return screen.width; },  
 106142: () => { return screen.height; },  
 106168: () => { return window.screenX; },  
 106195: () => { return window.screenY; },  
 106222: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 106275: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 106346: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 106403: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 106659: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 106730: () => { if (document.fullscreenElement) return 1; },  
 106776: () => { return window.innerWidth; },  
 106802: () => { return window.innerHeight; },  
 106829: () => { if (document.pointerLockElement) return 1; }
};
